...
public class LoginForm extends javax.swing.JFrame {
	...
	private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if ((this.txtUserName.getText().equals("admin"))& (this.txtPassword.getText().equals("admin"))){
    		...
    		Invoice i1 = new Invoice( "100","0001",200);
    		Invoice i2 = new Invoice( "101","0001",300);
    		Invoice i3 = new Invoice( "102","0002",3860);
    		Invoice i4 = new Invoice( "200","0003",1200);
    		Invoice i5 = new Invoice( "301","0003",2300);
